...
class DataTestCraftExperienceLevels < Test::Unit::TestCase
  ...
  def test_craft_experience_table
    assert_equal 180, AtlanticaOnlineCraftCalculator::CraftExperience.levels.size
    assert_equal 180, AtlanticaOnlineCraftCalculator::CraftExperience.levels.map { |xp_lvl| xp_lvl.lvl }.uniq.size
    assert_equal 180, AtlanticaOnlineCraftCalculator::CraftExperience.levels.map { |xp_lvl| xp_lvl.xp }.uniq.size
